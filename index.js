...
async function createWindow() {
    ...
    // Check app version
    try {
        const { data: { version: requiredVersion } } = await axios.get('https://physicsuniverse.tq-box.net/required-version.json');
    ...
    win.loadURL('https://physicsuniverse.tq-box.net/login/');
